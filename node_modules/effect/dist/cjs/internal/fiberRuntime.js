...
/** @internal */
const invokeWithInterrupt = (self, entries, onInterrupt) => core.fiberIdWith(id => ensuring(core.flatMap(forkDaemon(core.interruptible(self)), processing => core.async(cb => {
